    ...
    <nav>
        <div class="container nav__container">
            <a class="custom__links" href="index.php">
                <h4 class="title">E-LEARN<br> <h5> Educational Center</h5> </h4> 
            ...
            <ul class="nav__menu">
                ...
                <!-- <li>
                    <a class="custom__links" href="Assistance.php">Assistance</a>
                </li> -->
                <li>
                    <a class="custom__links" href="Admin\index.php">Admin</a>
                </li>
                <!-- <li>
                    <a class="custom__links" href="Assistance.php">Assistant</a>
                </li> -->
                <?php
                session_start();
